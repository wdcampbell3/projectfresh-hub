import { a6 as sanitize_props, a7 as rest_props, a8 as attributes, Y as clsx, _ as slot, a9 as bind_props, $ as ensure_array_like, X as attr_class } from "./index2.js";
...
function Input($$renderer, $$props) {
  ...
  $$renderer.component(($$renderer2) => {
    ...
    const inputDefaultStyles = css({
      ...
      "&:hover": { borderColor: "$inputBorderHover", outline: "none" },
      "&:focus": { borderColor: "$inputBorderFocus", outline: "none" },
      "&::placeholder": { color: "$inputPlaceholder", letterSpacing: "initial" },
...
function EmailAuth($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<form method="post" class="svelte-4u5flj">`);
      Container($$renderer3, {
        direction: "vertical",
        gap: "large",
        appearance,
        children: ($$renderer4) => {
          Container($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              Label($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.[lngKey]?.email_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> `);
              ...
              Label($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.[lngKey]?.password_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> `);
          ...
          Button($$renderer4, {
            ...
            appearance,
            children: ($$renderer5) => {
              $$renderer5.push(`<!---->${escape_html(i18n?.[lngKey]?.button_label)}`);
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!----> `);
              ...
              children: ($$renderer5) => {
                if (authView === VIEWS.SIGN_IN && magicLink) {
                  ...
                  Anchor($$renderer5, {
                    ...
                    appearance,
                    children: ($$renderer6) => {
                      $$renderer6.push(`<!---->${escape_html(i18n?.magic_link?.link_text)}`);
                    },
                    $$slots: { default: true }
                  });
                } else {
                ...
                if (authView === VIEWS.SIGN_IN) {
                  ...
                  Anchor($$renderer5, {
                    ...
                    appearance,
                    children: ($$renderer6) => {
                      $$renderer6.push(`<!---->${escape_html(i18n?.forgotten_password?.link_text)}`);
                    },
                    $$slots: { default: true }
                  });
                  $$renderer5.push(`<!----> `);
                  Anchor($$renderer5, {
                    ...
                    appearance,
                    children: ($$renderer6) => {
                      $$renderer6.push(`<!---->${escape_html(i18n?.sign_up?.link_text)}`);
                    },
                    $$slots: { default: true }
                  });
                  $$renderer5.push(`<!---->`);
                  ...
                  Anchor($$renderer5, {
                    ...
                    appearance,
                    children: ($$renderer6) => {
                      $$renderer6.push(`<!---->${escape_html(i18n?.sign_in?.link_text)}`);
                    },
                    $$slots: { default: true }
                  });
                }
...
function ForgottenPassword($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let i18n = $$props["i18n"];
    let supabaseClient = $$props["supabaseClient"];
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<form id="auth-forgot-password" method="post" class="svelte-1xnv8y">`);
      Container($$renderer3, {
        direction: "vertical",
        gap: "large",
        appearance,
        children: ($$renderer4) => {
          Container($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              Label($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.forgotten_password?.email_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> `);
              ...
              Button($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.forgotten_password?.button_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
          ...
          if (showLinks) {
            ...
            Anchor($$renderer4, {
              ...
              appearance,
              children: ($$renderer5) => {
                $$renderer5.push(`<!---->${escape_html(i18n?.sign_in?.link_text)}`);
              },
              $$slots: { default: true }
            });
          } else {
...
function MagicLink($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let i18n = $$props["i18n"];
    let supabaseClient = $$props["supabaseClient"];
    let authView = $$props["authView"];
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<form id="auth-magic-link" method="post" class="svelte-3httqa">`);
      Container($$renderer3, {
        direction: "vertical",
        gap: "large",
        appearance,
          ...
          Container($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              Label($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.magic_link?.email_input_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> `);
              ...
              Button($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.magic_link?.button_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
...
function SocialAuth($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
            ...
            children: ($$renderer4) => {
              ...
              for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
                ...
                Button($$renderer4, {
                  ...
                  appearance,
                  children: ($$renderer5) => {
                    Icons($$renderer5, { provider });
                    $$renderer5.push(`<!----> `);
                    if (verticalSocialLayout) {
                      $$renderer5.push("<!--[-->");
                      $$renderer5.push(`${escape_html(iconTitle(provider))}`);
                    } else {
                      $$renderer5.push("<!--[!-->");
                    }
                    $$renderer5.push(`<!--]-->`);
...
function UpdatePassword($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<form id="auth-update-password" method="post" class="svelte-12qqhep">`);
      Container($$renderer3, {
        direction: "vertical",
        gap: "large",
        appearance,
          ...
          Container($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              Label($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.update_password?.password_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!----> `);
              ...
              Button($$renderer5, {
                ...
                appearance,
                children: ($$renderer6) => {
                  $$renderer6.push(`<!---->${escape_html(i18n?.update_password?.button_label)}`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
    ...
    $$renderer2.subsume($$inner_renderer);
    bind_props($$props, { i18n, supabaseClient, authView, appearance, showLinks });
  });
}
function VerifyOtp($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    let i18n = $$props["i18n"];
    let supabaseClient = $$props["supabaseClient"];
    let authView = $$props["authView"];
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<form id="auth-magic-link" method="post" class="svelte-oaman7">`);
      Container($$renderer3, {
        direction: "vertical",
        gap: "large",
        appearance,
        children: ($$renderer4) => {
          if (["sms", "phone_change"].includes(otpType)) {
            ...
            Label($$renderer4, {
              ...
              appearance,
              children: ($$renderer5) => {
                $$renderer5.push(`<!---->${escape_html(i18n?.verify_otp?.phone_input_label)}`);
              },
              $$slots: { default: true }
            });
            $$renderer4.push(`<!----> `);
            ...
            Label($$renderer4, {
              ...
              appearance,
              children: ($$renderer5) => {
                $$renderer5.push(`<!---->${escape_html(i18n?.verify_otp?.email_input_label)}`);
              },
              $$slots: { default: true }
            });
            $$renderer4.push(`<!----> `);
          ...
          Label($$renderer4, {
            ...
            appearance,
            children: ($$renderer5) => {
              $$renderer5.push(`<!---->${escape_html(i18n?.verify_otp?.token_input_label)}`);
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!----> `);
          ...
          Button($$renderer4, {
            ...
            appearance,
            children: ($$renderer5) => {
              $$renderer5.push(`<!---->${escape_html(i18n?.verify_otp?.button_label)}`);
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!----> `);
...
function Auth($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let $$inner_renderer;
    function $$render_inner($$renderer3) {
      $$renderer3.push(`<div${attr_class(clsx(theme !== "default" ? themeVariables : ""))}>`);
      if (SignView) {
        $$renderer3.push("<!--[-->");
        SocialAuth($$renderer3, {
          appearance,
          supabaseClient,
          providers,
          providerScopes,
